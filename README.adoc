    ...
    steps:
      ...
      - id: print-outputs-from-trivy-step
        ...
        run: |
            ...
            echo "Policy subject: ${{steps.trivy-step.outputs.policy-subject}}"
...
jobs:
  job1:
    outputs:
      ...
      trivy-job-output-policy-subject: ${{ steps.trivy-step.outputs.policy-subject }}
    steps:
      - name: check out source code
        uses: cloudbees-io/checkout@v1
        with:
    ...
    steps:
      - id: print-outputs-from-job1
        ...
        run: |
          ...
          echo "Policy subject: ${{ needs.job1.outputs.trivy-job-output-policy-subject }}"
